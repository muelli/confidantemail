...
rem xcopy "C:\Program Files (x86)\GNU\GnuPG\*.*" "build\exe.win32-2.7\" /s/e/c/h
mkdir "build\exe.win32-2.7\bin" "build\exe.win32-2.7\lib" "build\exe.win32-2.7\share"
xcopy "C:\Program Files (x86)\GnuPG.v2\bin\*.*" "build\exe.win32-2.7\bin" /s/e/c/h
xcopy "C:\Program Files (x86)\GnuPG.v2\lib\*.*" "build\exe.win32-2.7\lib" /s/e/c/h
xcopy "C:\Program Files (x86)\GnuPG.v2\share\*.*" "build\exe.win32-2.7\share" /s/e/c/h
del help.zip
cd help
zip ..\help.zip *.*
cd ..
...
copy confmail.gpg2.nsi build\exe.win32-2.7\src
copy confmail.winxp.nsi build\exe.win32-2.7\src
copy confmail.winxp.gpg2.nsi build\exe.win32-2.7\src
copy make_release.cmd build\exe.win32-2.7\src
copy make_release_gpg2.cmd build\exe.win32-2.7\src
copy make_release_serv.cmd build\exe.win32-2.7\src
copy make_release_winxp.cmd build\exe.win32-2.7\src
copy make_release_winxp_gpg2.cmd build\exe.win32-2.7\src
copy make_release_macos.bash build\exe.win32-2.7\src
copy make_release_macos_gpg2.bash build\exe.win32-2.7\src
copy cms_kad.py build\exe.win32-2.7\src
...
cd ..\..
del entangled\*.pyc
del entangled\kademlia\*.pyc
zip build\confmail-src.zip keyicon.ico keyicon.icns build-notes.txt readme_gpgv2.txt
zip -r build\confmail-src.zip entangled make_linux.bash
copy confmail.gpg2.nsi build\exe.win32-2.7\
"\Program Files (x86)\NSIS\makensis.exe" c:\projects\keymail\build\exe.win32-2.7\confmail.gpg2.nsi
move build\exe.win32-2.7\confmailinst.exe build\
echo done
goto :eof
