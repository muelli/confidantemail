...
# cp /usr/local/lib/python2.7/site-packages/cryptography/_Cryptography_cffi_2a871178xb3816a41.so build/Confidant\ Mail-0.44.app/Contents/MacOS/_Cryptography_cffi_2a871178xb3816a41.so
# cp /usr/local/lib/python2.7/site-packages/cryptography/_Cryptography_cffi_4ee21876x41fb9936.so build/Confidant\ Mail-0.44.app/Contents/MacOS/_Cryptography_cffi_4ee21876x41fb9936.so
# cp /usr/local/lib/python2.7/site-packages/cryptography/_Cryptography_cffi_590da19fxffc7b1ce.so build/Confidant\ Mail-0.44.app/Contents/MacOS/_Cryptography_cffi_590da19fxffc7b1ce.so
# cp /usr/local/lib/python2.7/site-packages/cryptography/_Cryptography_cffi_8f86901cxc1767c5a.so build/Confidant\ Mail-0.44.app/Contents/MacOS/_Cryptography_cffi_8f86901cxc1767c5a.so
cp /usr/local/lib/python2.7/site-packages/_cffi_backend.so ./build/exe.macosx-10.9-x86_64-2.7/
cp /usr/local/lib/python2.7/site-packages/_cffi_backend.so ./build/Confidant\ Mail-0.44.app/Contents/MacOS/

mkdir build/Confidant\ Mail-0.44.app/Contents/MacOS/enchant
cp \
...
build/Confidant\ Mail-0.44.app/Contents/MacOS/enchant
cp -r /usr/local/lib/python2.7/site-packages/enchant/share \
build/Confidant\ Mail-0.44.app/Contents/MacOS/
...
rm build/Confidant\ Mail-0.44.app/Contents/MacOS/libwx_baseu-3.0.dylib
rm build/Confidant\ Mail-0.44.app/Contents/MacOS/libwx_baseu_xml-3.0.dylib
rm build/Confidant\ Mail-0.44.app/Contents/MacOS/libwx_osx_cocoau_adv-3.0.dylib
rm build/Confidant\ Mail-0.44.app/Contents/MacOS/libwx_osx_cocoau_core-3.0.dylib
rm build/Confidant\ Mail-0.44.app/Contents/MacOS/libwx_osx_cocoau_html-3.0.dylib
...
( cd build/Confidant\ Mail-0.44.app/Contents/MacOS ; tar xf - )
...
cp help.zip build/Confidant\ Mail-0.44.app/Contents/MacOS/ 

( cd build/Confidant\ Mail-0.44.app/Contents/MacOS ; ln -s . lib )

for fn in \
  build/Confidant\ Mail-0.44.app/Contents/MacOS/bin/gpg \
  build/Confidant\ Mail-0.44.app/Contents/MacOS/bin/gpgconf \
  build/Confidant\ Mail-0.44.app/Contents/MacOS/bin/gpg-agent \
  build/Confidant\ Mail-0.44.app/Contents/MacOS/bin/gpg-connect-agent \
  build/Confidant\ Mail-0.44.app/Contents/MacOS/libexec/scdaemon \
  build/Confidant\ Mail-0.44.app/Contents/MacOS/libgcrypt.20.dylib \
  build/Confidant\ Mail-0.44.app/Contents/MacOS/libassuan.0.dylib \
  build/Confidant\ Mail-0.44.app/Contents/MacOS/libksba.8.dylib \
  build/Confidant\ Mail-0.44.app/Contents/MacOS/libgpg-error.0.dylib \
; do
