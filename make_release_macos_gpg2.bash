...
for fn in \
  build/Confidant\ Mail-0.45.app/Contents/MacOS/bin/gpg \
  build/Confidant\ Mail-0.45.app/Contents/MacOS/bin/gpgconf \
  build/Confidant\ Mail-0.45.app/Contents/MacOS/bin/gpg-agent \
  build/Confidant\ Mail-0.45.app/Contents/MacOS/bin/gpg-connect-agent \
  build/Confidant\ Mail-0.45.app/Contents/MacOS/libexec/scdaemon \
  build/Confidant\ Mail-0.45.app/Contents/MacOS/libgcrypt.20.dylib \
  build/Confidant\ Mail-0.45.app/Contents/MacOS/libassuan.0.dylib \
  build/Confidant\ Mail-0.45.app/Contents/MacOS/libksba.8.dylib \
  build/Confidant\ Mail-0.45.app/Contents/MacOS/libgpg-error.0.dylib \
; do
