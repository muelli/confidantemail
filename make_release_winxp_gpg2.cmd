...
rem xcopy "C:\Program Files\GNU\GnuPG\*.*" "build\exe.win32-2.7\" /s/e/c/h
mkdir "build\exe.win32-2.7\bin" "build\exe.win32-2.7\lib" "build\exe.win32-2.7\share"
xcopy "C:\Program Files\GnuPG.v2\bin\*.*" "build\exe.win32-2.7\bin" /s/e/c/h
xcopy "C:\Program Files\GnuPG.v2\lib\*.*" "build\exe.win32-2.7\lib" /s/e/c/h
xcopy "C:\Program Files\GnuPG.v2\share\*.*" "build\exe.win32-2.7\share" /s/e/c/h
del help.zip
cd help
zip ..\help.zip *.*
cd ..
...
copy confmail.winxp.gpg2.nsi build\exe.win32-2.7\
"\Program Files\NSIS\makensis.exe" c:\projects\keymail\build\exe.win32-2.7\confmail.winxp.gpg2.nsi
